...
from nomad.datamodel.metainfo.eln import PublicationReference, Substance
from nomad.datamodel.results import Cell, SymmetryNew
...
class TemperatureSeries(ArchiveSection):
    """
    A section describing a temperature dependent property.
    """
    ...
    name = Quantity(
        type=str,
        description="""
        A descriptive name for this series. This is used to identify the series in
        plots.
        """,
...
class ElasticStiffness(TemperatureSeries, ArchiveSection):
    ...
    name = Quantity(
        type=str,
        description="""
        A descriptive name for this series. It could be derived form the reference such
        as `Jordan 1980`.
        """,
        a_eln={'component': 'StringEditQuantity'},
    )
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Elastic Stiffness'},
        shape=['*'],
        unit='Pa',
    )
    publication_reference = SubSection(
...
class Viscosity(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Viscosity'},
        shape=['*'],
        unit='Pa*s',
    )
    publication_reference = SubSection(
...
class SurfaceTension(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Surface tension'},
        shape=['*'],
        unit='N/m',
    )
    publication_reference = SubSection(
...
class GrowthAngle(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Growth angle'},
        shape=['*'],
        unit='deg',
    )
    publication_reference = SubSection(
...
class ThermalExpansion(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Thermal expansion'},
        shape=['*'],
        unit='1/K',
    )
    publication_reference = SubSection(
...
class HeatCapacity(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Heat capacity'},
        shape=['*'],
        unit='J/(kg*K)',
    )
    publication_reference = SubSection(
...
class HeatConductivity(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Heat conductivity'},
        shape=['*'],
        unit='W/(m*K)',
    )
    publication_reference = SubSection(
...
class Emissivity(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Emisivity'},
        shape=['*'],
    )
...
class ElectricalConductivity(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Electrical conductivity'},
        shape=['*'],
        unit='S/m',
    )
    publication_reference = SubSection(
...
class MagneticSusceptibility(TemperatureSeries, ArchiveSection):
    ...
    values = Quantity(
        ...
        The critical resolved shear stress of the material.
        """,
        a_eln={'component': 'NumberEditQuantity', 'label': 'Magentic susceptibility'},
        shape=['*'],
        unit=' ',
    )
    publication_reference = SubSection(
    ...
    m_def = Section(
        a_plot=[
            ...
            },
            {
                'label': 'Critial resolved shear stress',
                'x': (
                    'mechanical_properties/critical_resolved_shear_stress/:/'
                    'temperatures'
                ),
